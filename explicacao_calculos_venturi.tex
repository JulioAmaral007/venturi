...
\begin{itemize}
    ...
    \item Fator de atrito: $f$ (não utilizado no modo ideal - sem atrito)
...
\begin{align*}
    h_{f,garganta} &= f \frac{L_{garganta}}{D_2} \frac{v_2^2}{2g} \\
    h_{f,garganta} &= 0.02 \cdot \frac{0.05}{0.05} \cdot \frac{(5.0930)^2}{2 \cdot 9.81} = 0.026441 \text{ m} \\
...
\begin{itemize}
    ...
    \item Densidade do fluido: $\rho = 1000$ kg/m³
    \item Densidade do fluido manométrico: $\rho_m = 13600$ kg/m³
    \item Vazão volumétrica: $Q = 0.025$ m³/s (alta vazão)
...
$P_3$ (Pa) & 101325.00 (recuperação total) & 96733.93 (perda de 4591 Pa) \\
$h_L$ (m) & 0.000000 & 0.467999 \\
...
\begin{itemize}
    ...
    \item No modo realista, há uma perda permanente de $P_1 - P_3 = 4591$ Pa
    \item A perda de carga total no modo realista é $h_L = 0.468$ m
